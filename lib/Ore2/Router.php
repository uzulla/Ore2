...
class Router
{
    ...
    public function any(string $path, callable $callback)
    {
    ...
    public function setRoute(string $method, string $path, callable $callback)
    {
    ...
    public function run(RequestInterface $request){
        ...
        array_walk($params, function(&$v){$v = urldecode($v);});
...
class RouterResult
{
    ...
    public function __construct(Container $container, callable $action, array $params)
    {
        $this->container = $container;
